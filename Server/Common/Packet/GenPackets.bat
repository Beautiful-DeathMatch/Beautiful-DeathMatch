...
XCOPY /Y InGamePacketManager.cs "../../../Client/Assets/Scripts/Network/Packet"
XCOPY /Y InGamePacketManager.cs "../../InGameServer/Packet"
...
XCOPY /Y RoomPacketManager.cs "../../../Client/Assets/Scripts/Network/Packet"
XCOPY /Y RoomPacketManager.cs "../../RoomServer/Packet"