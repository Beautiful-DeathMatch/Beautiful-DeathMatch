...
void TextureProjection_float(in Texture2D Tex, in SamplerState SS, in float3 Pos, in float3 Normal, in float Tile, in float Blend, in float Speed, in float Rotation, out float4 Out)
{
